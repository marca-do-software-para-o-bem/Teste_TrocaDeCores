          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                Icon(MdiIcons.square, size: 100, color: _ColorSquare()),
                Icon(MdiIcons.squareRounded, size: 100, color: _ColorSquareRounded()),
                Icon(MdiIcons.circle, size: 100, color: _ColorCircle())
              ]), Divider(),
              Row(
